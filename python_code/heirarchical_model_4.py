...
mod_data = os.path.join('.','modeldata/hierarchical_data_model_4.json')
os.makedirs('data/output/hierarchical_model_4', exist_ok=True)
output_dir = os.path.join('.','data/output/hierarchical_model_4')
