...
mod_data = os.path.join('.','modeldata/hierarchical_data_model_9.json')
os.makedirs('data/output/hierarchical_model_9', exist_ok=True)
output_dir = os.path.join('.','data/output/hierarchical_model_9')


# 3. Run the Hamiltonian Monte Carlo (HMC) sampler--note max_treedepth = 12
