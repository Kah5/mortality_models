...
mod_data = os.path.join('.','modeldata/hierarchical_data_model_7.json')
os.makedirs('data/output/hierarchical_model_7', exist_ok=True)
output_dir = os.path.join('.','data/output/hierarchical_model_7')
